...
local Class = class:new(
    ...
    IsResearchedOrResearching = {
        get = function(self) return self.IsEnabled or self.IsResearching end,
    },

    IsNextGeneration = {
        get = function(self)
            return not (self.IsEnabled or self.IsReady or self.IsResearching)
        end,
    },
    ...
    IsNextGenerationRaw = {
        get = function(self)
            return not (self.IsEnabled or self.IsReadyRaw)
        end,
    },
...
function Class:IsBefore(other)
    ...
    if self.IsEnabled ~= other.IsEnabled then return self.IsEnabled end
